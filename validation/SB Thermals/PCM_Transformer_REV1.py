...
percent_conduction = 0.1        # Percent of wire mass contacting toroid for conductive heat transfer
...
ax[col].set_title("Best Scenario for Primary Winding")
ax[col].grid(True)
...
ax[col].set_xlabel("Time (s)")
ax[col].set_ylabel("Temperature (C)")
ax[col].set_title("Best Scenario for Secondary Winding")
ax[col].grid(True)

plt.tight_layout(pad=1)

plt.savefig("Best_Case_Wire_Parameters_1.png")