...
fullDataOutPath = "sim_inputs_and_outputs/dynamicsCalcs_auto80.csv"
# For output plots
...
for i in range(0, num_intervals-1):
    ...
    # If in the 5 minute driver-swap period:
    if laps_completed == 11 and driverSwap == "Incomplete":
        # execute function to determine cooling of cells over 5 minutes - assuming that fans are still running
        dataDict = dynF.driverSwapCooling(dataDict, i)
        driverSwap = "Complete"
